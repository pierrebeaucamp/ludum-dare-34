...
(function(exports) {
  ...
  var update = function (state) {
      return function __do() {
          var _4 = Prelude.liftM1(Control_Monad_Eff.monadEff)(function (_12) {
              return Helper.unpackMilliseconds(Data_Date.toEpochMilliseconds(_12));
          })(Data_Date.now)();
          return Prelude["return"](Control_Monad_Eff.applicativeEff)((function () {
              var _6 = {};
              for (var _7 in state) {
                  if (state.hasOwnProperty(_7)) {
                      _6[_7] = state[_7];
                  };
              };
              _6.lastTime = new Data_Maybe.Just(_4);
              return _6;
          })())();
      };
  };
